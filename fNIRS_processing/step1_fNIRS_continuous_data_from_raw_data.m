...
for k=1:23
    ...
    HbR=y2(:,list_HbR);
    HbT=y2(:,list_HbT);
    save([PATH2,'HbO_',num2str(k),'-2.mat'],'HbO');
    save([PATH2,'HbR_',num2str(k),'-2.mat'],'HbR');
    save([PATH2,'HbT_',num2str(k),'-2.mat'],'HbT');
    %%
    cd(PATH1);
    list1=dir(['sub',num2str(k),'_*']);
    cd([PATH1,list1(1).name]);
    ...
    HbR=y2(:,list_HbR);
    HbT=y2(:,list_HbT);
    save([PATH2,'HbO_',num2str(k),'-3.mat'],'HbO');
    save([PATH2,'HbR_',num2str(k),'-3.mat'],'HbR');
    save([PATH2,'HbT_',num2str(k),'-3.mat'],'HbT');
end
